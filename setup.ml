...
(* OASIS_START *)
(* DO NOT EDIT (digest: de406b68998344084849acaf1cfb3a47) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("netcamlbox", None);
     ...
     oasis_digest = Some "\173\226>\169\222\175A\231\030\151R\138r)\131s";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
