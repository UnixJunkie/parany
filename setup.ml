...
(* OASIS_START *)
(* DO NOT EDIT (digest: b5388413cb3e559ae3aefb355f8d96f8) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("netmulticore", None);
                           FindlibPackage ("posix-semaphore", None)
                        ];
     ...
     oasis_digest = Some "2\138\192\208=\185\192R&h\234\205\189\148P\247";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
